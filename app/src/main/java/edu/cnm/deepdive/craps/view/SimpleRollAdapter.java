...
public class SimpleRollAdapter extends ArrayAdapter<int[]> {
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    TextView die_0 = view.findViewById(R.id.die_0);
    TextView die_1 =view.findViewById(R.id.die_1);
    int[] diceRoll = getItem(position);
    die_0.setText(Integer.toString(diceRoll[0]));
    die_1.setText(Integer.toString(diceRoll[1]));
    return view;
  }
